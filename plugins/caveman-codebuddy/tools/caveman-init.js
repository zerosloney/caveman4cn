#!/usr/bin/env node
// caveman init (CodeBuddy build) — drop the always-on caveman activation rule
// into a target repo's AGENTS.md. CodeBuddy reads AGENTS.md on every session,
...
// (CodeBuddy's discovery convention). Cursor/Windsurf/Cline/Copilot/OpenClaw
